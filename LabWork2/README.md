...
* адаптера публикации доменных событий — исходящего адаптера, который осуществляет монтироинг событий.
 ...
 <img width="700" src="Images/5.png" alt="1"/>
...
Аутентификационный сервис небходим для валидации персональных пользовательских данных и последующего предоставления доступа пользователю к системе. Информация передается в хешированном виде и обеспечивает недежность личных данных.
Описание адаптеров:
* адаптера REST API — входящего адаптера, который реализует REST API для
вызова бизнес-логики
* адаптера обработчика команд — входящего адаптера, который потребляет из канала
...
* адаптера публикации доменных событий — исходящего адаптера, который осуществляет монтироинг событий.
 ...
 <img width="700" src="Images/3_2.png" alt="1"/>
