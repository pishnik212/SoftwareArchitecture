...
### Диаграмма прецедентов для функциональных требований администратора системы
...
Скорость отклика в периоды пиковых нагрузок составляет не более 10 секунд.

**5. Восстанавливаемость:**

Система должна выполнять резервное копирование с частотой 1 сутки.
